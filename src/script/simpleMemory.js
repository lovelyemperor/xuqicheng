...
function getVersionConfig() {
    ...
    if (window.cnblogsConfig.GhUserName === 'BNDong') {
        ...
        var url = 'https://cdn.jsdelivr.net/gh/'+(window.cnblogsConfig.GhUserName)+'/'+(window.cnblogsConfig.GhRepositories)+'@'+(window.cnblogsConfig.GhVersions)+'/'+'version.conf';        $.ajax({
            type: "get",
            url: url,
            dataType: "text",
            async: false,
